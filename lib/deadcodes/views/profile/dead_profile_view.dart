...
class DeadProfileView extends StatefulWidget {
  const DeadProfileView({Key? key}) : super(key: key);

  @override
  _DeadProfileViewState createState() => _DeadProfileViewState();
}

class _DeadProfileViewState extends State<DeadProfileView> {
  ...
  Future<void> _loadUserIncomes() async {
    if (user != null) {
      incomes = await dead_getUserIncomes(
  ...
  Future<void> _saveIncome() async {
    if (user != null &&
      ...
      if (_editingIncomeId != null) {
        await dead_deleteIncome(user!.uid, _editingIncomeId!);
      }
  ...
  Future<void> _deleteIncome(DeadIncomeModel income) async {
    if (income.id != null) {
      await dead_deleteIncome(user!.uid, income.id!);
      _loadUserIncomes();
    }
  }
