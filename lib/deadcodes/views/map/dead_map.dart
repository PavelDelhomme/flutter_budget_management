...
class DeadMapPage extends StatefulWidget {
  const DeadMapPage({super.key});

  @override
  _DeadMapPageState createState() => _DeadMapPageState();
}

class _DeadMapPageState extends State<DeadMapPage> {
