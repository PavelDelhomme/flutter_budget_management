...
class DeadBudgetDetailsScreen extends StatefulWidget {
  final String budgetId;

  const DeadBudgetDetailsScreen({Key? key, required this.budgetId}) : super(key: key);

  @override
  _DeadBudgetDetailsScreenState createState() => _DeadBudgetDetailsScreenState();
}

class _DeadBudgetDetailsScreenState extends State<DeadBudgetDetailsScreen> {
