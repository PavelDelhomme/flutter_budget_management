...
import '../../../services/budget/dead_add_transaction.dart';
import '../../../services/dead_image_service.dart';


class DeadTransactionFormScreen extends StatefulWidget {
  final String? budgetId;
  final DocumentSnapshot? transaction;

  const DeadTransactionFormScreen({Key? key, this.budgetId, this.transaction}) : super(key: key);

  @override
  _DeadTransactionFormScreenState createState() => _DeadTransactionFormScreenState();
}

class _DeadTransactionFormScreenState extends State<DeadTransactionFormScreen> {
